        ...
        <section className='max-padd-container mx-5'>
            <div className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-screen w-full rounded-3xl'>
                <div className='relative top-32 xs:top-52'>
                    ...
                    <p className='text-gray-50 regular-16 my-10 max-w-[33rem] '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit iure, saepe accusamus quaerat cumque vitae, id nobis quam consequuntur ullam molestiae illo ad. Iure itaque perferendis expedita soluta quisquam exercitationem est vitae quod!</p>
