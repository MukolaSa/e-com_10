                        ...
                        <div className="flex flex-col sm:flex-row gap-x-10 gap-y-3 my-6">
                            ...
                            <div>
                                ...
                                <div className="flex gap-3 my-3">
                                    ...
                                    <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-full bg-secondaryYellow"></div>
                                    <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-full bg-secondaryBlue"></div>
                                    <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-full bg-secondaryGreen"></div>
                                </div>
                            </div>
                            <div>
                                <h4 className="bold-16">Select Size:</h4>
                                <div className="flex gap-3 my-3">
                                    <div className="ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-md bg-tertiary text-white">S</div>
                                    <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-md">M</div>
                                    <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-md">L</div>
                                    <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-md">XL</div>
                                </div>
                            </div>
                        </div>
