            ...
            <div className="grid gap-8 grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
                ...
                <div>
                    ...
                    <div className="px-5">
                        ...
                        <p className="my-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem, eius? Repellendus.</p>
                        <Link to={'/mens'} className="bold-15 text-secondary">View more..</Link>
                    </div>
                </div>
                <div>
                    <div className="ring-1 ring-slate-900/5 rounded-3xl bg-secondaryRed text-white">
                        <img src={women} alt="" className="rounded-3xl " />
                    </div>
                    <div className="px-5">
                        <h4 className="medium-18 mt-4">Top Rated Women Collection</h4>
                        <p className="my-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem, eius? Repellendus.</p>
                        <Link to={'/womens'} className="bold-15 text-secondary">View more..</Link>
                    </div>
                </div>
                <div>
                    ...
                    <div className="px-5">
                        ...
                        <p className="my-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem, eius? Repellendus.</p>
                        <Link to={'/kids'} className="bold-15 text-secondary">View more..</Link>
                    </div>
                </div>
            </div>
